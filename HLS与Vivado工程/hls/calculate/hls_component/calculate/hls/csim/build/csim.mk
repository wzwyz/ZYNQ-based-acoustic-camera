...
HLS_SOURCES = ../../../../../src/tb_calculate.cpp ../../../../../src/calculate.cpp
...
$(ObjDir)/tb_calculate.o: ../../../../../src/tb_calculate.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/tb_calculate.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_calculate.d

$(ObjDir)/calculate.o: ../../../../../src/calculate.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/calculate.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/calculate.d
