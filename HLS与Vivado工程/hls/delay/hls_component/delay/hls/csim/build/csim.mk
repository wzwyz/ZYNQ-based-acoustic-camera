...
HLS_SOURCES = ../../../../../src/tb_delay.cpp ../../../../../src/delay.cpp
...
$(ObjDir)/tb_delay.o: ../../../../../src/tb_delay.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/tb_delay.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_delay.d

$(ObjDir)/delay.o: ../../../../../src/delay.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/delay.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
