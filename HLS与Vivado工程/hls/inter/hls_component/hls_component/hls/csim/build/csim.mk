...
HLS_SOURCES = ../../../../../src/tb_inter.cpp ../../../../../src/inter.cpp
...
$(ObjDir)/tb_inter.o: ../../../../../src/tb_inter.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/tb_inter.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_inter.d

$(ObjDir)/inter.o: ../../../../../src/inter.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/inter.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/inter.d
