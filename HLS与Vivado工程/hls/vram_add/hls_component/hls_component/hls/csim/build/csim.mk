...
HLS_SOURCES = ../../../../tb_vram_add.cpp ../../../../vram_add.cpp
...
$(ObjDir)/tb_vram_add.o: ../../../../tb_vram_add.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tb_vram_add.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_vram_add.d

$(ObjDir)/vram_add.o: ../../../../vram_add.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../vram_add.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/vram_add.d
