...
set target_clk_period_ns "2.778"
set target_clk_freq_hz [expr {floor(1000 / $target_clk_period_ns) * 1000000}]
set ip_vlnv xilinx.com:hls:vram_add:1.0
set ip_repo_path ../ip
...
dict set report_options topmodule "vram_add"
dict set report_options funcmodules {}
dict set report_options bindmodules vram_add_add_64s_64ns_64_3_1
