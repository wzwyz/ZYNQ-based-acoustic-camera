...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: ExtremalSearcher_0, and set properties
	set ExtremalSearcher_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ExtremalSearcher:1.0 ExtremalSearcher_0 ]
	...
	# Connect all clock & reset of ExtremalSearcher_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ExtremalSearcher_0/Monitor]
	connect_bd_net [get_bd_pins ExtremalSearcher_0/monitor_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ExtremalSearcher_0/monitor_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ExtremalSearcher_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ExtremalSearcher_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ExtremalSearcher_0_Monitor_* ]]
	puts $fp "set monitor_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:ExtremalSearcher:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ExtremalSearcher_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ExtremalSearcher_hw_${i}"
