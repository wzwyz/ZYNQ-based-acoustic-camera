...
module add_image_Loop_loop_height_proc3_Pipeline_loop_width (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] start_1_out;
output   start_1_out_ap_vld;
output  [0:0] eol_out;
output   eol_out_ap_vld;

reg ap_idle;
reg SRC_STREAM_TREADY;
reg start_1_out_ap_vld;
reg eol_out_ap_vld;
...
wire    ap_loop_init;
reg   [31:0] ap_phi_mux_start_2_phi_fu_123_p4;
wire   [31:0] ap_phi_reg_pp0_iter1_start_2_reg_120;
reg   [31:0] ap_phi_mux_start_3_phi_fu_133_p4;
wire   [31:0] ap_phi_reg_pp0_iter1_start_3_reg_130;
reg   [31:0] j_fu_62;
wire   [31:0] j_4_fu_200_p2;
wire   [31:0] j_6_fu_214_p2;
reg   [31:0] ap_sig_allocacmp_j_5;
reg   [31:0] start_1_fu_66;
reg    ap_block_pp0_stage0_01001;
reg    srcImg_data_write_local;
...
always @ (*) begin
    if ((icmp_ln122_fu_158_p2 == 1'd1)) begin
        if ((or_ln131_fu_188_p2 == 1'd0)) begin
            ap_phi_mux_start_2_phi_fu_123_p4 = 32'd1;
...
always @ (*) begin
    if (((icmp_ln122_fu_158_p2 == 1'd1) & (or_ln134_fu_194_p2 == 1'd0) & (or_ln131_fu_188_p2 == 1'd1))) begin
        ap_phi_mux_start_3_phi_fu_133_p4 = 32'd0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op48_write_state3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        srcImg_data_write_local = 1'b1;
    end else begin
        srcImg_data_write_local = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln122_fu_158_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        start_1_out_ap_vld = 1'b1;
    end else begin
        start_1_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln122_fu_158_p2 == 1'd1) & (1'b0 == SRC_STREAM_TVALID));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((ap_predicate_op48_write_state3 == 1'b1) & (srcImg_data_full_n == 1'b0));
end
...
assign ap_phi_reg_pp0_iter1_start_2_reg_120 = 'bx;

assign ap_phi_reg_pp0_iter1_start_3_reg_130 = 'bx;
...
assign eol_out = eol_reg_108;

assign icmp_ln122_fu_158_p2 = (($signed(j_fu_62) < $signed(32'd1280)) ? 1'b1 : 1'b0);

assign icmp_ln131_fu_176_p2 = ((start_1_fu_66 != 32'd0) ? 1'b1 : 1'b0);

assign j_4_fu_200_p2 = ($signed(j_fu_62) + $signed(32'd4294967295));

assign j_6_fu_214_p2 = (ap_sig_allocacmp_j_5 + 32'd1);

assign or_ln131_fu_188_p2 = (xor_ln131_fu_182_p2 | icmp_ln131_fu_176_p2);

assign or_ln134_fu_194_p2 = (icmp_ln131_fu_176_p2 | SRC_STREAM_TUSER);

assign srcImg_data_din = axi_data_reg_256;

assign srcImg_data_write = srcImg_data_write_local;

assign start_1_out = start_1_fu_66;

assign xor_ln131_fu_182_p2 = (1'd1 ^ SRC_STREAM_TUSER);

endmodule //add_image_Loop_loop_height_proc3_Pipeline_loop_width
