...
entity add_image_Loop_loop_height_proc14_Pipeline_loop_width is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of add_image_Loop_loop_height_proc14_Pipeline_loop_width is 
...
attribute shreg_extract : string;
    ...
    signal CAM_STREAM_TDATA_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal camImg_data_blk_n : STD_LOGIC;
    signal eol_2_reg_108 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_phi_mux_start_phi_fu_123_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_start_reg_120 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_start_4_phi_fu_133_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_start_4_reg_130 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_2_fu_62 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal j_fu_200_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_11_fu_214_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_j_10 : STD_LOGIC_VECTOR (31 downto 0);
    signal start_3_fu_66 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal camImg_data_write_local : STD_LOGIC;
...
begin
    ...
    eol_2_reg_108_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    start_3_fu_66_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    CAM_STREAM_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, CAM_STREAM_TVALID, icmp_ln122_fu_158_p2, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln122_fu_158_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ...
            CAM_STREAM_TDATA_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    CAM_STREAM_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln122_fu_158_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln122_fu_158_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            CAM_STREAM_TREADY <= ap_const_logic_1;
        else 
            CAM_STREAM_TREADY <= ap_const_logic_0;
        end if; 
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(CAM_STREAM_TVALID, icmp_ln122_fu_158_p2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln122_fu_158_p2 = ap_const_lv1_1) and (ap_const_logic_0 = CAM_STREAM_TVALID));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(camImg_data_full_n, ap_predicate_op48_write_state3)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((ap_predicate_op48_write_state3 = ap_const_boolean_1) and (camImg_data_full_n = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_start_4_phi_fu_133_p4_assign_proc : process(icmp_ln122_fu_158_p2, or_ln131_fu_188_p2, or_ln134_fu_194_p2, ap_phi_mux_start_phi_fu_123_p4, ap_phi_reg_pp0_iter1_start_4_reg_130)
    begin
        if (((icmp_ln122_fu_158_p2 = ap_const_lv1_1) and (or_ln134_fu_194_p2 = ap_const_lv1_0) and (or_ln131_fu_188_p2 = ap_const_lv1_1))) then 
            ap_phi_mux_start_4_phi_fu_133_p4 <= ap_const_lv32_0;
    ...
    ap_phi_mux_start_phi_fu_123_p4_assign_proc : process(icmp_ln122_fu_158_p2, or_ln131_fu_188_p2, or_ln134_fu_194_p2, ap_phi_reg_pp0_iter1_start_reg_120, start_3_fu_66)
    begin
        if ((icmp_ln122_fu_158_p2 = ap_const_lv1_1)) then
            if ((or_ln131_fu_188_p2 = ap_const_lv1_0)) then 
                ap_phi_mux_start_phi_fu_123_p4 <= ap_const_lv32_1;
    ...
    ap_phi_reg_pp0_iter1_start_4_reg_130 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ap_phi_reg_pp0_iter1_start_reg_120 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    ap_sig_allocacmp_j_10_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln122_fu_158_p2, ap_block_pp0_stage0, or_ln131_fu_188_p2, or_ln134_fu_194_p2, j_2_fu_62, j_fu_200_p2)
    begin
    ...
    camImg_data_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, camImg_data_full_n, ap_predicate_op48_write_state3, ap_block_pp0_stage0)
    begin
    ...
    camImg_data_din <= axi_data_reg_256;
    camImg_data_write <= camImg_data_write_local;

    camImg_data_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_predicate_op48_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op48_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            camImg_data_write_local <= ap_const_logic_1;
        else 
            camImg_data_write_local <= ap_const_logic_0;
        end if; 
    end process;

    eol_2_out <= eol_2_reg_108;

    eol_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln122_fu_158_p2, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln122_fu_158_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            eol_2_out_ap_vld <= ap_const_logic_1;
        else 
            eol_2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln122_fu_158_p2 <= "1" when (signed(j_2_fu_62) < signed(ap_const_lv32_500)) else "0";
    icmp_ln131_fu_176_p2 <= "0" when (start_3_fu_66 = ap_const_lv32_0) else "1";
    j_11_fu_214_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_10) + unsigned(ap_const_lv32_1));
    j_fu_200_p2 <= std_logic_vector(unsigned(j_2_fu_62) + unsigned(ap_const_lv32_FFFFFFFF));
    or_ln131_fu_188_p2 <= (xor_ln131_fu_182_p2 or icmp_ln131_fu_176_p2);
    or_ln134_fu_194_p2 <= (icmp_ln131_fu_176_p2 or CAM_STREAM_TUSER);
    start_3_out <= start_3_fu_66;

    start_3_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln122_fu_158_p2, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln122_fu_158_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            start_3_out_ap_vld <= ap_const_logic_1;
        else 
            start_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    xor_ln131_fu_182_p2 <= (ap_const_lv1_1 xor CAM_STREAM_TUSER);
end behav;
