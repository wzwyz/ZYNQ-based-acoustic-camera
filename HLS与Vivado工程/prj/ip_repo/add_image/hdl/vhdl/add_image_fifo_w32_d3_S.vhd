...
entity add_image_fifo_w32_d3_S is 
    generic (
...
architecture rtl of add_image_fifo_w32_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component add_image_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_add_image_fifo_w32_d3_S_ShiftReg : add_image_fifo_w32_d3_S_ShiftReg
    generic map (
...
entity add_image_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end add_image_fifo_w32_d3_S_ShiftReg;

architecture rtl of add_image_fifo_w32_d3_S_ShiftReg is
