...
entity add_image_start_for_alpha_add_720_1280_U0 is 
    generic (
...
architecture rtl of add_image_start_for_alpha_add_720_1280_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component add_image_start_for_alpha_add_720_1280_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_add_image_start_for_alpha_add_720_1280_U0_ShiftReg : add_image_start_for_alpha_add_720_1280_U0_ShiftReg
    generic map (
...
entity add_image_start_for_alpha_add_720_1280_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end add_image_start_for_alpha_add_720_1280_U0_ShiftReg;

architecture rtl of add_image_start_for_alpha_add_720_1280_U0_ShiftReg is
