...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "color_mapping_latency" -parent ${Page_0}
...
proc update_PARAM_VALUE.color_mapping_latency { PARAM_VALUE.color_mapping_latency } {
	# Procedure called to update color_mapping_latency when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.color_mapping_latency { PARAM_VALUE.color_mapping_latency } {
	# Procedure called to validate color_mapping_latency
	return true
}
...
proc update_MODELPARAM_VALUE.color_mapping_latency { MODELPARAM_VALUE.color_mapping_latency PARAM_VALUE.color_mapping_latency } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.color_mapping_latency}] ${MODELPARAM_VALUE.color_mapping_latency}
}
