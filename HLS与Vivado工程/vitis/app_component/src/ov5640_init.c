...
u8 ov5640_init(u8 cmos_ch,u16 cmos_h_pixel,  u16 cmos_v_pixel,  u16 total_h_pixel, u16 total_v_pixel )
{
    ...
    if(cam_id != 0x5640)  //��ȡ����ȷ��OV5640 ID
        return 1;
    else{
		//�ȶԼĴ�������������λ��ʹ�Ĵ����ָ���ʼֵ
		//�Ĵ���������λ����Ҫ��ʱ1ms�������������Ĵ���
		sccb_write_reg16(cmos_ch,0x3008,0x82); //Bit[7]:��λ Bit[6]:��Դ����

		//��ʱ1ms
		usleep(1000);

		sccb_write_reg16(cmos_ch,0x3008,0x02); //��������ģʽ
		...
		sccb_write_reg16(cmos_ch,0x3037,0x13); //PLL��Ƶ����
		sccb_write_reg16(cmos_ch,0x3108,0x01); //ϵͳ����Ƶ��
		...
		sccb_write_reg16(cmos_ch,0x3600,0x08); //VCM����,�����Զ��۽�
		sccb_write_reg16(cmos_ch,0x3601,0x33); //VCM����,�����Զ��۽�
		sccb_write_reg16(cmos_ch,0x302d,0x60); //ϵͳ����
		sccb_write_reg16(cmos_ch,0x3620,0x52);
		sccb_write_reg16(cmos_ch,0x371b,0x20);
		sccb_write_reg16(cmos_ch,0x471c,0x50);
		sccb_write_reg16(cmos_ch,0x3a13,0x43); //AEC(�Զ��ع����)
		sccb_write_reg16(cmos_ch,0x3a18,0x00); //AEC ��������
		sccb_write_reg16(cmos_ch,0x3a19,0xf8); //AEC ��������
		...
		sccb_write_reg16(cmos_ch,0x3c06,0x00); //light meter 1 ��ֵ[15:8]
		sccb_write_reg16(cmos_ch,0x3c07,0x08); //light meter 1 ��ֵ[7:0]
		sccb_write_reg16(cmos_ch,0x3c08,0x00); //light meter 2 ��ֵ[15:8]
		sccb_write_reg16(cmos_ch,0x3c09,0x1c); //light meter 2 ��ֵ[7:0]
		...
		sccb_write_reg16(cmos_ch,0x4001,0x02); //BLC(�ڵ�ƽУ׼)������ʼ�к�
		sccb_write_reg16(cmos_ch,0x4005,0x1a); //BLC(�ڵ�ƽУ׼)����ʼ�ո���
		sccb_write_reg16(cmos_ch,0x3000,0x00); //ϵͳ�鸴λ����
		sccb_write_reg16(cmos_ch,0x3004,0xff); //ʱ��ʹ�ܿ���
		sccb_write_reg16(cmos_ch,0x4300,0x61); //��ʽ���� RGB565
		sccb_write_reg16(cmos_ch,0x501f,0x01); //ISP RGB
		sccb_write_reg16(cmos_ch,0x440e,0x00);
		sccb_write_reg16(cmos_ch,0x5000,0xa7); //ISP����
		sccb_write_reg16(cmos_ch,0x3a0f,0x30); //AEC����;stable range in high
		sccb_write_reg16(cmos_ch,0x3a10,0x28); //AEC����;stable range in low
		sccb_write_reg16(cmos_ch,0x3a1b,0x30); //AEC����;stable range out high
		sccb_write_reg16(cmos_ch,0x3a1e,0x26); //AEC����;stable range out low
		sccb_write_reg16(cmos_ch,0x3a11,0x60); //AEC����; fast zone high
		sccb_write_reg16(cmos_ch,0x3a1f,0x14); //AEC����; fast zone low
...
//		sccb_write_reg16(cmos_ch,0x3036,0x3c); //PLL��Ƶ  //48M
		sccb_write_reg16(cmos_ch,0x3036,0x5A); //PLL��Ƶ  //72M
		...
		//����������ظ���
		sccb_write_reg16(cmos_ch,0x3808, cmos_h_pixel >> 8     );  //DVP ���ˮƽ���ص�����4λ
		sccb_write_reg16(cmos_ch,0x3809, cmos_h_pixel & 0x00FF );  //DVP ���ˮƽ���ص�����8λ
		sccb_write_reg16(cmos_ch,0x380a, cmos_v_pixel >> 8     );  //DVP �����ֱ���ص�����3λ
		sccb_write_reg16(cmos_ch,0x380b, cmos_v_pixel & 0x00FF );  //DVP �����ֱ���ص�����8λ
		sccb_write_reg16(cmos_ch,0x380c, total_h_pixel >> 8    );  //ˮƽ�����ش�С��5λ
		sccb_write_reg16(cmos_ch,0x380d, total_h_pixel & 0x00FF);  //ˮƽ�����ش�С��8λ
		sccb_write_reg16(cmos_ch,0x380e, total_v_pixel >> 8    );  //��ֱ�����ش�С��5λ
		sccb_write_reg16(cmos_ch,0x380f, total_v_pixel & 0x00FF);  //��ֱ�����ش�С��8λ
		...
		sccb_write_reg16(cmos_ch,0x4004,0x02); //BLC(����) 2 lines
		...
		sccb_write_reg16(cmos_ch,0x5001,0xa3); //ISP ����
		sccb_write_reg16(cmos_ch,0x3b07,0x0a); //֡�ع�ģʽ
		//��������ʹ��
		sccb_write_reg16(cmos_ch,0x503d,0x00); //0x00:����ģʽ 0x80:������ʾ
		//��������ƹ���
		sccb_write_reg16(cmos_ch,0x3016,0x02);
		sccb_write_reg16(cmos_ch,0x301c,0x02);
		sccb_write_reg16(cmos_ch,0x3019,0x02); //�������
		sccb_write_reg16(cmos_ch,0x3019,0x00); //�ر������
		return 0;
	}
